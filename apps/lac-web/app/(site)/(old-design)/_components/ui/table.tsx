...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "bg-brand-gray-100 [&_tr]:border-b-2 [&_tr]:border-t [&_tr]:border-y-brand-gray-200",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-11 text-nowrap px-4 text-left align-middle font-bold text-brand-gray-500 [&:has([role=checkbox])]:pr-0",
      className,
    )}
    {...props}
  />
